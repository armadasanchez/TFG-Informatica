...
def run(gamma, beta, output, totalData, train_set, test_set, user_objective = 'all', group_objective = 'all', puzzle_objective = 'all'):
    ...
    if(output == 'metrics'):
        ...
        if(output == 'standard'): 
            ...
            resultadoPuzzle = difficulty_ELO[difficulty_ELO['task_id'] == puzzle_objective]
            dificultad = round(resultadoPuzzle['normalized_difficulty'].sum(), 2)
